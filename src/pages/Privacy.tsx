  ...
  return (
    <PublicShell>
      <header className="privacy-heading">
        ...
        <span className="privacy-version">{legalPublished ? 'Versão · 14 set 2026' : 'Versão para revisão · 14 set 2026'}</span>
      </header>

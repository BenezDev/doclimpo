  ...
  return (
    <PublicShell>
      <header className="privacy-heading">
        ...
        <span className="privacy-version">Versão · 14 set 2026</span>
      </header>
      <div className="privacy-layout">
        ...
        <article className="privacy-body">
          ...
          <section id="planos"><h2>03. Plano gratuito e planos pagos</h2><p>O plano gratuito permite acompanhar <strong>um documento</strong>, com alertas por e-mail, sem informar cartão. Não há prazo de validade para o plano gratuito.</p><p>Quando planos pagos estiverem disponíveis, preço, periodicidade e limites serão exibidos antes da contratação, e a cobrança será recorrente até o cancelamento, que pode ser feito a qualquer momento pela sua conta. Em compras feitas pela internet, você pode desistir em até 7 dias após a contratação, com devolução do valor pago, conforme o Código de Defesa do Consumidor.</p></section>
          <section id="alertas"><h2>04. Alertas</h2><p>Os avisos são enviados por e-mail nas janelas de 90, 30, 7 e 1 dia antes da data cadastrada. Prazos já passados no momento do cadastro não geram avisos retroativos. Você pode pausar os avisos na sua conta.</p><p>A entrega depende de fatores fora do nosso controle: e-mail correto, caixa cheia, filtros de spam e disponibilidade do provedor de envio. Por isso, os alertas são um apoio à sua organização, não uma garantia. Mantenha sua própria conferência das datas.</p></section>

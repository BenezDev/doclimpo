...
import { WHATSAPP_DISPONIVEL } from '../lib/planos'
    ...
    <PublicShell>
      ...
      <div className="privacy-layout">
        ...
        <article className="privacy-body">
          ...
          <section id="objeto"><h2>01. O que o DocLimpo faz</h2><p>O DocLimpo organiza datas de vencimento de documentos que você cadastra (CNH, CRLV, IPVA, multa de trânsito, passaporte, RG, seguro auto, plano de saúde, carteira de trabalho, garantia, contrato, exame periódico e outros) e envia avisos por e-mail antes do prazo. Também mostra orientações de renovação, links para os canais oficiais de consulta e pagamento de multas e, se você informar seu endereço, unidades de atendimento próximas.</p><p>O DocLimpo <strong>não</strong> renova documentos, não paga taxas nem multas, não consulta cadastros de órgãos públicos (nem multas ou débitos de veículos) e não substitui a conferência das datas por você. A data informada no cadastro é a referência de todos os avisos.</p></section>
          ...
          <section id="encerramento"><h2>07. Encerramento</h2><p>Você pode excluir sua conta a qualquer momento em <Link to="/conta">Minha conta</Link>. A exclusão remove seus documentos, alertas, veículos, endereço e perfil, e encerra o acesso. Podemos suspender ou encerrar contas usadas de forma abusiva ou contrária a estes termos, avisando pelo e-mail cadastrado quando possível.</p></section>

export const faqs = [
  ...
  { question: 'Como e quando recebo os alertas?', answer: 'Os avisos são por e-mail, nas janelas de 90, 30, 7 e 1 dia antes do vencimento. Prazos já passados não geram avisos retroativos. Confira seu endereço e a pasta de spam; mantenha também sua própria conferência das datas.' },

export const faqs = [
  ...
  { question: 'Quais documentos posso acompanhar?', answer: 'CNH, CRLV, IPVA, passaporte, RG, seguro auto, plano de saúde, carteira de trabalho, garantia de produto, contrato, exame periódico e outros documentos. Você informa a data aplicável ao seu caso: o DocLimpo não consulta nem calcula vencimentos em órgãos oficiais.' },
...
const documentTypes = ['cnh', 'crlv', 'ipva', 'passaporte', 'rg', 'seguro', 'plano_saude', 'carteira_trabalho', 'garantia', 'contrato', 'exame', 'outro']

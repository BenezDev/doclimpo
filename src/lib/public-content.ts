export const faqs = [
  ...
  { question: 'Quais documentos posso acompanhar?', answer: 'CNH, CRLV, IPVA, multa de trânsito (prazo de defesa, desconto ou recurso), passaporte, RG, seguro auto, plano de saúde, carteira de trabalho, garantia de produto, contrato, exame periódico e outros documentos. Você informa a data aplicável ao seu caso: o DocLimpo não consulta nem calcula vencimentos em órgãos oficiais. Para multas, ele mostra onde consultar: Detran do seu estado, Portal SENATRAN e adesão ao SNE.' },
  ...
  { question: 'O DocLimpo renova o documento por mim?', answer: 'Não. O DocLimpo organiza datas, avisos e orientações. A renovação e o pagamento de taxas e multas continuam sendo feitos por você, nos canais oficiais responsáveis pelo documento.' },
...
export const useCases = [
  { type: 'multa', number: '01', label: 'No para-brisa', title: 'A multa tem prazo. O desconto também.', context: 'A notificação chega, vai para a gaveta e o prazo de defesa ou de pagar com desconto passa.', action: 'Cadastre a data da notificação: o DocLimpo calcula o prazo legal, avisa antes e mostra onde consultar e pagar.', cta: 'Acompanhar minha multa', detail: 'Multa · Prazo da notificação' },
  { type: 'cnh', number: '02', label: 'Na rotina', title: 'Sua CNH não avisa que vai vencer.', context: 'Você dirige todos os dias. A data de validade, nem sempre olha.', action: 'Cadastre o vencimento da CNH e consulte os próximos passos antes de renovar.', cta: 'Acompanhar minha CNH', detail: 'CNH · Habilitação' },
  { type: 'passaporte', number: '03', label: 'Na próxima viagem', title: 'O embarque começa antes da mala.', context: 'Passagem, hospedagem, roteiro. E a validade do passaporte?', action: 'Organize a data e confira as exigências do destino com antecedência.', cta: 'Acompanhar meu passaporte', detail: 'Passaporte · Viagem' },
  { type: 'seguro', number: '04', label: 'No seu planejamento', title: 'A renovação merece espaço na agenda.', context: 'A apólice vence enquanto o resto da vida acontece.', action: 'Registre o fim da vigência para ter o prazo à mão ao conversar com sua seguradora.', cta: 'Acompanhar meu seguro', detail: 'Seguro auto · Vigência' },
]
